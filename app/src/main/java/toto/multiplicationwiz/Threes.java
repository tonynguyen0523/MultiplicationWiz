...
public class Threes extends AppCompatActivity {

    @Override
    protected  void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.threes_layout);
    ...
    public void threeResult(View v){
        int correct = 0;

        EditText Answer1 = (EditText)findViewById(R.id.edit_three_1);
        EditText Answer2 = (EditText)findViewById(R.id.edit_three_2);
        EditText Answer3 = (EditText)findViewById(R.id.edit_three_3);
        EditText Answer4 = (EditText)findViewById(R.id.edit_three_4);
        EditText Answer5 = (EditText)findViewById(R.id.edit_three_5);
        EditText Answer6 = (EditText)findViewById(R.id.edit_three_6);
        EditText Answer7 = (EditText)findViewById(R.id.edit_three_7);
        EditText Answer8 = (EditText) findViewById(R.id.edit_three_8);
        EditText Answer9 = (EditText)findViewById(R.id.edit_three_9);
        EditText Answer10 = (EditText)findViewById(R.id.edit_three_10);
        EditText Answer11 = (EditText)findViewById(R.id.edit_three_11);
        EditText Answer12 = (EditText)findViewById(R.id.edit_three_12);
        EditText Answer13 = (EditText)findViewById(R.id.edit_three_13);
        EditText Answer14 = (EditText)findViewById(R.id.edit_three_14);
        EditText Answer15 = (EditText)findViewById(R.id.edit_three_15);
        EditText Answer16 = (EditText)findViewById(R.id.edit_three_16);
        EditText Answer17 = (EditText)findViewById(R.id.edit_three_17);
        EditText Answer18 = (EditText)findViewById(R.id.edit_three_18);
        EditText Answer19 = (EditText)findViewById(R.id.edit_three_19);
        EditText Answer20 = (EditText)findViewById(R.id.edit_three_20);
        EditText Answer21 = (EditText)findViewById(R.id.edit_three_21);
        EditText Answer22 = (EditText)findViewById(R.id.edit_three_22);
        EditText Answer23 = (EditText)findViewById(R.id.edit_three_23);
        EditText Answer24 = (EditText)findViewById(R.id.edit_three_24);

        TextView displayCorrect = (TextView)findViewById(R.id.display_threes_result);
        ...
        //displays results
        if(correct == 24){
            Intent congrats = new Intent(Threes.this, Congrats.class);
