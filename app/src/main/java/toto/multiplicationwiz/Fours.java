...
public class Fours extends AppCompatActivity {

    @Override
    protected  void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fours_layout);

        Toast.makeText(this, "Do questions in order!", Toast.LENGTH_LONG).show();
    }
    //user presses finished button

    public void fourResult(View v){
        int correct = 0;

        EditText Answer1 = (EditText)findViewById(R.id.edit_four_1);
        EditText Answer2 = (EditText)findViewById(R.id.edit_four_2);
        EditText Answer3 = (EditText)findViewById(R.id.edit_four_3);
        EditText Answer4 = (EditText)findViewById(R.id.edit_four_4);
        EditText Answer5 = (EditText)findViewById(R.id.edit_four_5);
        EditText Answer6 = (EditText)findViewById(R.id.edit_four_6);
        EditText Answer7 = (EditText)findViewById(R.id.edit_four_7);
        EditText Answer8 = (EditText) findViewById(R.id.edit_four_8);
        EditText Answer9 = (EditText)findViewById(R.id.edit_four_9);
        EditText Answer10 = (EditText)findViewById(R.id.edit_four_10);
        EditText Answer11 = (EditText)findViewById(R.id.edit_four_11);
        EditText Answer12 = (EditText)findViewById(R.id.edit_four_12);
        EditText Answer13 = (EditText)findViewById(R.id.edit_four_13);
        EditText Answer14 = (EditText)findViewById(R.id.edit_four_14);
        EditText Answer15 = (EditText)findViewById(R.id.edit_four_15);
        EditText Answer16 = (EditText)findViewById(R.id.edit_four_16);
        EditText Answer17 = (EditText)findViewById(R.id.edit_four_17);
        EditText Answer18 = (EditText)findViewById(R.id.edit_four_18);
        EditText Answer19 = (EditText)findViewById(R.id.edit_four_19);
        EditText Answer20 = (EditText)findViewById(R.id.edit_four_20);
        EditText Answer21 = (EditText)findViewById(R.id.edit_four_21);
        EditText Answer22 = (EditText)findViewById(R.id.edit_four_22);
        EditText Answer23 = (EditText)findViewById(R.id.edit_four_23);
        EditText Answer24 = (EditText)findViewById(R.id.edit_four_24);

        TextView displayCorrect = (TextView)findViewById(R.id.display_fours_result);
        ...
        //displays results
        if(correct == 24){
            Intent congrats = new Intent(Fours.this, Congrats.class);
