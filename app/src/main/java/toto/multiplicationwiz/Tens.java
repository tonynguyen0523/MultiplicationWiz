...
public class Tens extends AppCompatActivity {
    ...
    protected  void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.tens_layout);
    ...
    public void tenResult(View v){
        int correct = 0;

        EditText Answer1 = (EditText)findViewById(R.id.edit_ten_1);
        EditText Answer2 = (EditText)findViewById(R.id.edit_ten_2);
        EditText Answer3 = (EditText)findViewById(R.id.edit_ten_3);
        EditText Answer4 = (EditText)findViewById(R.id.edit_ten_4);
        EditText Answer5 = (EditText)findViewById(R.id.edit_ten_5);
        EditText Answer6 = (EditText)findViewById(R.id.edit_ten_6);
        EditText Answer7 = (EditText)findViewById(R.id.edit_ten_7);
        EditText Answer8 = (EditText) findViewById(R.id.edit_ten_8);
        EditText Answer9 = (EditText)findViewById(R.id.edit_ten_9);
        EditText Answer10 = (EditText)findViewById(R.id.edit_ten_10);
        EditText Answer11 = (EditText)findViewById(R.id.edit_ten_11);
        EditText Answer12 = (EditText)findViewById(R.id.edit_ten_12);
        EditText Answer13 = (EditText)findViewById(R.id.edit_ten_13);
        EditText Answer14 = (EditText)findViewById(R.id.edit_ten_14);
        EditText Answer15 = (EditText)findViewById(R.id.edit_ten_15);
        EditText Answer16 = (EditText)findViewById(R.id.edit_ten_16);
        EditText Answer17 = (EditText)findViewById(R.id.edit_ten_17);
        EditText Answer18 = (EditText)findViewById(R.id.edit_ten_18);
        EditText Answer19 = (EditText)findViewById(R.id.edit_ten_19);
        EditText Answer20 = (EditText)findViewById(R.id.edit_ten_20);
        EditText Answer21 = (EditText)findViewById(R.id.edit_ten_21);
        EditText Answer22 = (EditText)findViewById(R.id.edit_ten_22);
        EditText Answer23 = (EditText)findViewById(R.id.edit_ten_23);
        EditText Answer24 = (EditText)findViewById(R.id.edit_ten_24);


        TextView displayCorrect = (TextView)findViewById(R.id.display_tens_result);
        ...
        //displays results
        if(correct == 24){
            Intent congrats = new Intent(Tens.this, Congrats.class);
