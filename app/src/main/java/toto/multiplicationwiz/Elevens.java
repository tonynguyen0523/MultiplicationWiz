...
public class Elevens extends AppCompatActivity {

    @Override
    protected  void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.elevens_layout);
    ...
    public void elevenResult(View v){
        int correct = 0;

        EditText Answer1 = (EditText)findViewById(R.id.edit_eleven_1);
        EditText Answer2 = (EditText)findViewById(R.id.edit_eleven_2);
        EditText Answer3 = (EditText)findViewById(R.id.edit_eleven_3);
        EditText Answer4 = (EditText)findViewById(R.id.edit_eleven_4);
        EditText Answer5 = (EditText)findViewById(R.id.edit_eleven_5);
        EditText Answer6 = (EditText)findViewById(R.id.edit_eleven_6);
        EditText Answer7 = (EditText)findViewById(R.id.edit_eleven_7);
        EditText Answer8 = (EditText) findViewById(R.id.edit_eleven_8);
        EditText Answer9 = (EditText)findViewById(R.id.edit_eleven_9);
        EditText Answer10 = (EditText)findViewById(R.id.edit_eleven_10);
        EditText Answer11 = (EditText)findViewById(R.id.edit_eleven_11);
        EditText Answer12 = (EditText)findViewById(R.id.edit_eleven_12);
        EditText Answer13 = (EditText)findViewById(R.id.edit_eleven_13);
        EditText Answer14 = (EditText)findViewById(R.id.edit_eleven_14);
        EditText Answer15 = (EditText)findViewById(R.id.edit_eleven_15);
        EditText Answer16 = (EditText)findViewById(R.id.edit_eleven_16);
        EditText Answer17 = (EditText)findViewById(R.id.edit_eleven_17);
        EditText Answer18 = (EditText)findViewById(R.id.edit_eleven_18);
        EditText Answer19 = (EditText)findViewById(R.id.edit_eleven_19);
        EditText Answer20 = (EditText)findViewById(R.id.edit_eleven_20);
        EditText Answer21 = (EditText)findViewById(R.id.edit_eleven_21);
        EditText Answer22 = (EditText)findViewById(R.id.edit_eleven_22);
        EditText Answer23 = (EditText)findViewById(R.id.edit_eleven_23);
        EditText Answer24 = (EditText)findViewById(R.id.edit_eleven_24);

        TextView displayCorrect = (TextView)findViewById(R.id.display_elevens_result);
        ...
        //displays results
        if(correct == 24){
            Intent congrats = new Intent(Elevens.this, Congrats.class);
