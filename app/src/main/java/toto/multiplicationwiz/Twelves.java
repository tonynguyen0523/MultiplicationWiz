...
public class Twelves extends AppCompatActivity {

    @Override
    protected  void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.twelves_layout);
    ...
    public void twelveResult(View v){
        int correct = 0;

        EditText Answer1 = (EditText)findViewById(R.id.edit_twelve_1);
        EditText Answer2 = (EditText)findViewById(R.id.edit_twelve_2);
        EditText Answer3 = (EditText)findViewById(R.id.edit_twelve_3);
        EditText Answer4 = (EditText)findViewById(R.id.edit_twelve_4);
        EditText Answer5 = (EditText)findViewById(R.id.edit_twelve_5);
        EditText Answer6 = (EditText)findViewById(R.id.edit_twelve_6);
        EditText Answer7 = (EditText)findViewById(R.id.edit_twelve_7);
        EditText Answer8 = (EditText) findViewById(R.id.edit_twelve_8);
        EditText Answer9 = (EditText)findViewById(R.id.edit_twelve_9);
        EditText Answer10 = (EditText)findViewById(R.id.edit_twelve_10);
        EditText Answer11 = (EditText)findViewById(R.id.edit_twelve_11);
        EditText Answer12 = (EditText)findViewById(R.id.edit_twelve_12);
        EditText Answer13 = (EditText)findViewById(R.id.edit_twelve_13);
        EditText Answer14 = (EditText)findViewById(R.id.edit_twelve_14);
        EditText Answer15 = (EditText)findViewById(R.id.edit_twelve_15);
        EditText Answer16 = (EditText)findViewById(R.id.edit_twelve_16);
        EditText Answer17 = (EditText)findViewById(R.id.edit_twelve_17);
        EditText Answer18 = (EditText)findViewById(R.id.edit_twelve_18);
        EditText Answer19 = (EditText)findViewById(R.id.edit_twelve_19);
        EditText Answer20 = (EditText)findViewById(R.id.edit_twelve_20);
        EditText Answer21 = (EditText)findViewById(R.id.edit_twelve_21);
        EditText Answer22 = (EditText)findViewById(R.id.edit_twelve_22);
        EditText Answer23 = (EditText)findViewById(R.id.edit_twelve_23);
        EditText Answer24 = (EditText)findViewById(R.id.edit_twelve_24);

        TextView displayCorrect = (TextView)findViewById(R.id.display_twelves_result);
        ...
        //displays result
        if(correct == 24){
            Intent congrats = new Intent(Twelves.this, Congrats.class);
